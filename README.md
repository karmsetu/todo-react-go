# A simple to do app with CRUD operations using [React](https://react.dev/) as frontend, [go](https://go.dev/) as backend and [mongo](https://www.mongodb.com/) as database
